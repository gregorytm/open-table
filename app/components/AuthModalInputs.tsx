...
export default function AuthModalInputs({ inputs, handleChangeInput, isSignin }: Props) {
  return (
    ...
    {isSignin ? null: <div className="my-3 flex justify-between text-sm">
        <input
          type="text"
          className="border rounded p-2 py-3 bg-white text-black w-[49%]"
      ...
      <div className="my-3 flex justify-between text-black text-sm">
        <input
          type="text"
      ...
      {isSignin ? null: <div className="my-3 flex justify-between text-black text-sm">
        <input
          type="text"
          className="border rounded p-2 py-3 bg-white text-black w-[49%]"
          placeholder="Phone"
        ...
        <input
          type="text"
          className="border rounded p-2 py-3 bg-white w-[49%] text-black"
          placeholder="City"
          value={inputs.city}
          onChange={handleChangeInput}
          name="city"
